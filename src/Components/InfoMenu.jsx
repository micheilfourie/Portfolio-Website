...
const InfoMenu = () => {
  return (
    <div className="bg-navy-700 grid h-full w-full grid-rows-[250px_1fr_60px] shadow-md">
      <div className="from-navy-500 to-navy-600 flex w-full flex-col items-center justify-center bg-gradient-to-tr shadow-sm">
      ...
      <div className="scrollbar-hidden divide-navy-500 flex h-[calc(100vh-250px-60px-30px)] flex-col gap-4 divide-y overflow-y-scroll p-6 text-sm">
        ...
        <div className="flex justify-evenly py-4 pb-8">
          <div className="flex flex-col items-center gap-2">
            <CircleProgressBar progress={94} />
            <p className="text-white">Afrikaans</p>
          </div>

          <div className="flex flex-col items-center gap-2">
            <CircleProgressBar progress={82} />
      ...
      <div className="from-navy-500 to-navy-600 flex items-center justify-center bg-gradient-to-tr shadow-sm">
        ...
        <a href="" target="_blank">
          <FontAwesomeIcon icon={faGithub} className="p-4 text-xl text-white" />
        </a>
      </div>
    </div>
  );
